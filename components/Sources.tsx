  ...
  return (
    <div className="bg-white max-lg:-order-1 lg:flex lg:w-full lg:max-w-[300px] lg:flex-col">
      ...
      <div className="flex w-full items-center gap-6 pb-4 max-lg:overflow-x-scroll lg:grow lg:flex-col lg:gap-4 lg:overflow-y-scroll lg:pb-0">
        {isLoading ? (
          <>
            <div className="bg-gray-300 h-20 w-[260px] max-w-sm animate-pulse rounded-md" />
            <div className="bg-gray-300 h-20 w-[260px] max-w-sm animate-pulse rounded-md" />
            <div className="bg-gray-300 hidden h-20 w-[260px] max-w-sm animate-pulse rounded-md sm:block" />
            <div className="bg-gray-300 hidden h-20 w-[260px] max-w-sm animate-pulse rounded-md sm:block" />
            <div className="bg-gray-300 hidden h-20 w-[260px] max-w-sm animate-pulse rounded-md lg:block" />
            <div className="bg-gray-300 hidden h-20 w-[260px] max-w-sm animate-pulse rounded-md lg:block" />
            <div className="bg-gray-300 hidden h-20 w-[260px] max-w-sm animate-pulse rounded-md lg:block" />
            <div className="bg-gray-300 hidden h-20 w-[260px] max-w-sm animate-pulse rounded-md lg:block" />
            <div className="bg-gray-300 hidden h-20 w-[260px] max-w-sm animate-pulse rounded-md lg:block" />
...
const SourceCard = ({ source }: { source: { name: string; url: string } }) => {
  return (
    <div className="border-gray-100 flex h-[79px] w-full items-center gap-2.5 rounded-lg border px-1.5 py-1 shadow-md">
